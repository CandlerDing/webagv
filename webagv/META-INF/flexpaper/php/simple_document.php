...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <body> 
		...
		<div style="position:absolute;left:10px;top:10px;background-color:#EEEEEE;padding: 5px 5px 5px 5px; width:650px;font-family:Verdana;font-size:9pt">
			Currently viewing: <input type=text style="width:270px" id="txt_doc" value="<?php print $doc ?>"><input type="submit" value="Load" onclick="document.location='simple_document.php?doc='+$('#txt_doc').val()" style="float:right;" /><br/>
