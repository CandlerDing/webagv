...
(function() {
	...
	var IE = document.all,
		 URL = '/flexpaper/flashplayer13_install_win_ax.zip',
		...
		// express install
			...
			if (!root.innerHTML.replace(/\s/g, '')) {
				...
				var errinfo = 
					...
					(root.tagName == 'A' ? "<p>Click <a href='" + URL + "'>here</a> to download latest version</p>" : 
						"<p>Download latest version from <a href='" + URL + "'>here</a></p>");
				
				var pageHost = ((document.location.protocol == "https:") ? "https://" :	"http://");
				*/
				$("#installinfo").append( "Çëµã»÷ÏÂÔØÔ¤ÀÀ²å¼þ£º<a href='/flexpaper/flashplayer13_install_win_ax.zip'><img src='/flexpaper/get_flash_player.gif' alt='Get Adobe Flash player' border='0'/></a>");
			...
			if (opts.onFail) {
				...
				if (typeof ret == 'string') { $("#installinfo").append(  ret); }	
			}			
		}
