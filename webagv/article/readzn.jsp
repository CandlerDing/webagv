...
<% 
int id = ParamUtils.getIntParameter(request,"id",9);
Article article = new Article();
article = article.getById(id);
String url = article.getSiteurl();
if(url.length()==0){
	out.print(HtmlTool.msgBox(request, "暂无"));
	   return;
}else{
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    <head> 
		...
		<script>
		var w_max = window.screen.availWidth-230;
			var h_max = window.screen.availHeight-220;
    ...
    <div id="index_layoutRead" style="top:0px;border:0px;"  >
    	...
    	<div id="installinfo"></div>
	        <a id="viewerPlaceHolder" style="width:380px;height:530px;display:block"></a>
