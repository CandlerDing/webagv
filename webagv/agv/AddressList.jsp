...
function save() {
            if (doValidate('postForm_Address')) postForm_Address.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Address.cmd.value = 'list' ;document.queryForm_Address.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Address.cmd.value = 'excel'; document.queryForm_Address.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[存放地址]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Address" id="queryForm_Address">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_Address')" />
</td></tr></form></table>
</div>
