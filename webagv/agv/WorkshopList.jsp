...
function save() {
            if (doValidate('postForm_Workshop')) postForm_Workshop.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Workshop.cmd.value = 'list' ;document.queryForm_Workshop.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Workshop.cmd.value = 'excel'; document.queryForm_Workshop.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[车间管理]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Workshop" id="queryForm_Workshop">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_Workshop')" />
</td></tr></form></table>
</div>
