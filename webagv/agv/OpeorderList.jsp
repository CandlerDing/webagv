...
function save() {
            if (doValidate('postForm_Opeorder')) postForm_Opeorder.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Opeorder.cmd.value = 'list' ;document.queryForm_Opeorder.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Opeorder.cmd.value = 'excel'; document.queryForm_Opeorder.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[操作指令]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Opeorder" id="queryForm_Opeorder">
...
<input name="_Retvalue_" id="_Retvalue_" value="<%=ParamUtils.getParameter(request, "_Retvalue_", "")%>">
</td>
<td>
<div align="right">是否有操作数据</div>
</td><td>
<%=HtmlTool.renderSelect(YesNooptions, ParamUtils.getParameter(request,"_Type_",""), "_Type_", "")%>
<%//radio形式%>
<%//YesNooptions.remove(0);%>
<%//=HtmlTool.renderRadio(YesNooptions, ParamUtils.getParameter(request,"_Type_",""), "_Type_", "")%>
<%//checkbox形式%>
<%//=HtmlTool.renderCheckBox(YesNooptions, ParamUtils.getParameter(request,"_Type_",""), "_Type_", "")%>
</td>
</tr><tr>
<td>
<div align="right">查询指令总字节数</div>
</td><td>
<input name="_Lenvalue_" id="_Lenvalue_" value="<%=ParamUtils.getParameter(request, "_Lenvalue_", "")%>">
</td>
<td>
<div align="right">回复指令总字节数</div>
</td><td>
<input name="_LenRetvalue_" id="_LenRetvalue_" value="<%=ParamUtils.getParameter(request, "_LenRetvalue_", "")%>">
</td>
<td colspan="2">&nbsp;</td>
</tr><tr><td colspan="8" align="center">
<input type="button" value="Reset" onClick="clearForm('queryForm_Opeorder')" />
</td></tr></form></table>
</div>
