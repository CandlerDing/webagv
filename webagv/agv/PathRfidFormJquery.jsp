...
<%
Log log = LogFactory.getLog(PathRfid.class);
...
PathRfid v = (PathRfid)request.getAttribute("fromBean");
if (v == null) {
...
function save() {
    	$("#postForm_PathRfid").attr("target","self");
    	$("#postForm_PathRfid").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	});
    	$("#postForm_PathRfid").form({
    	...
    	var isValid = $("#postForm_PathRfid").form("validate");
    	if (!isValid){
        		$.messager.alert("信息不完整", "请将信息填写完整后，再进行下一步");
        		$.messager.progress("close");
    	}else
    	{
        		$("#postForm_PathRfid").submit();
    	}
}
function initP() {
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_PathRfid" id="postForm_PathRfid">
...
<table border="0" width="100%" cellspacing="0">
<tr id="postForm_PathRfid_Pathid"><td class="td_label">
...
<tr id="postForm_PathRfid_RfidCode"><td class="td_label">
<div align="right">站点标识:</div>
</td><td class="td_value">
<input type="text" class="easyui-textbox" name="RfidCode"  id="RfidCode" size="50" maxlength="50" value="<%=v.getRfidCode()%>">
</td></tr>
<input type="hidden" name="NearId" id="NearId" value="<%=v.getNearId()%>">
<tr id="postForm_PathRfid_NearName"><td class="td_label">
<div align="right">靠近点名称:</div>
</td><td class="td_value">
<input type="text" class="easyui-textbox" name="NearName"  id="NearName" size="50" maxlength="50" value="<%=v.getNearName()%>">
</td></tr>
<tr id="postForm_PathRfid_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno"  id="Orderno" class="easyui-numberbox" size="-1" value="<%=v.getOrderno()%>"">
</td></tr>
<tr id="postForm_PathRfid_Remark"><td class="td_label">
