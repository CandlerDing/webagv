...
function save() {
    	$("#postForm_DataSource").attr("target","self");
    	$("#postForm_DataSource").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	});
    	$("#postForm_DataSource").form({
    	...
    	var isValid = $("#postForm_DataSource").form("validate");
    	if (!isValid){
...
<input type="text" class="easyui-textbox" name="Retvalue"  id="Retvalue" size="50" maxlength="50" value="<%=v.getRetvalue()%>">
</td></tr>
