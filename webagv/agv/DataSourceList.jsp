...
function save() {
            if (doValidate('postForm_DataSource')) postForm_DataSource.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_DataSource.cmd.value = 'list' ;document.queryForm_DataSource.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_DataSource.cmd.value = 'excel'; document.queryForm_DataSource.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[数据来源]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_DataSource" id="queryForm_DataSource">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_DataSource')" />
</td></tr></form></table>
</div>
