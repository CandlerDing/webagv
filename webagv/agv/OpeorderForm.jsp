...
<%
Log log = LogFactory.getLog(Opeorder.class);
...
Opeorder v = (Opeorder)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_Opeorder.reset();" style="cursor:pointer;"></li>
        <li><a href="OpeorderAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_Opeorder" id="postForm_Opeorder">
...
<tr id="postForm_Opeorder_Retvalue"><td class="td_label">
<div align="right">标识:</div>
</td><td class="td_value">
<input name="Retvalue" id="_Retvalue_" size="50" maxlength="50" value="<%=v.getRetvalue()%>">
</td></tr>
<tr id="postForm_Opeorder_Type"><td class="td_label">
<div align="right">是否有操作数据:</div>
</td><td class="td_value">
<%=HtmlTool.renderSelect(YesNooptions, v.getType(), "Type", "")%>
<%//radio形式%>
<%//YesNooptions.remove(0);%>
<%//=HtmlTool.renderRaio(YesNooptions, v.getType(), "Type", "")%>
<%//checkbox形式%>
<%//=HtmlTool.renderCheckBox(YesNooptions, v.getType(), "Type", "")%>
</td></tr>
<tr id="postForm_Opeorder_Lenvalue"><td class="td_label">
<div align="right">查询指令总字节数:</div>
</td><td class="td_value">
<input name="Lenvalue" id="_Lenvalue_" size="50" maxlength="50" value="<%=v.getLenvalue()%>">
</td></tr>
<tr id="postForm_Opeorder_LenRetvalue"><td class="td_label">
<div align="right">回复指令总字节数:</div>
</td><td class="td_value">
<input name="LenRetvalue" id="_LenRetvalue_" size="50" maxlength="50" value="<%=v.getLenRetvalue()%>">
</td></tr>
<tr id="postForm_Opeorder_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno" id="_Orderno_" value="<%=v.getOrderno()%>">
</td></tr>
<tr id="postForm_Opeorder_Remark"><td class="td_label">
