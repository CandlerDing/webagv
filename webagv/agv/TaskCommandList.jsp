...
function save() {
            if (doValidate('postForm_TaskCommand')) postForm_TaskCommand.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_TaskCommand.cmd.value = 'list' ;document.queryForm_TaskCommand.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_TaskCommand.cmd.value = 'excel'; document.queryForm_TaskCommand.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[任务命令]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_TaskCommand" id="queryForm_TaskCommand">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_TaskCommand')" />
</td></tr></form></table>
</div>
