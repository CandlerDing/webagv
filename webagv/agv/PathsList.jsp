...
function save() {
            if (doValidate('postForm_Paths')) postForm_Paths.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Paths.cmd.value = 'list' ;document.queryForm_Paths.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Paths.cmd.value = 'excel'; document.queryForm_Paths.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[路径管理]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Paths" id="queryForm_Paths">
...
<input name="_Start_" id="_Start_" value="<%=ParamUtils.getParameter(request, "_Start_", "")%>">
</td>
<td>
<div align="right">终点</div>
</td><td>
<input name="_End_" id="_End_" value="<%=ParamUtils.getParameter(request, "_End_", "")%>">
</td>
</tr><tr>
<td>
<div align="right">长度</div>
</td><td>
<input name="_Len_" id="_Len_" value="<%=ParamUtils.getParameter(request, "_Len_", "")%>">
</td>
<td>
<div align="right">方向</div>
</td><td>
<input name="_Dire_" id="_Dire_" value="<%=ParamUtils.getParameter(request, "_Dire_", "")%>">
</td>
<td>
...
<input name="_FxType_" id="_FxType_" value="<%=ParamUtils.getParameter(request, "_FxType_", "")%>">
</td>
<td colspan="4">&nbsp;</td>
</tr><tr><td colspan="8" align="center">
<input type="button" value="Reset" onClick="clearForm('queryForm_Paths')" />
</td></tr></form></table>
</div>
