...
function save() {
            if (doValidate('postForm_PathBs')) postForm_PathBs.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_PathBs.cmd.value = 'list' ;document.queryForm_PathBs.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_PathBs.cmd.value = 'excel'; document.queryForm_PathBs.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[路径标识点管理]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_PathBs" id="queryForm_PathBs">
...
<input name="_OnlyId_" id="_OnlyId_" value="<%=ParamUtils.getParameter(request, "_OnlyId_", "")%>">
</td>
<td colspan="2">&nbsp;</td>
</tr><tr><td colspan="8" align="center">
<input type="button" value="Reset" onClick="clearForm('queryForm_PathBs')" />
</td></tr></form></table>
</div>
