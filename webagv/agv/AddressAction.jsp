...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "Code", "Name", "IdP", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[] DicKeys = {"Id", "Code", "Name", "IdP", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[][] DicValues = {{"int", "id", "-1", "hidden", ""}, {"string", "编码", "50", "text", ""}, {"string", "名称", "50", "text", ""}, {"int", "父ID", "-1", "hidden", ""}, {"int", "站点ID", "-1", "RfidName", ""}, {"string", "站点标识", "50", "text", ""}, {"string", "类型", "50", "text", ""}, {"int", "排序", "-1", "text", ""}, {"string", "备注", "50", "text", ""}};
private String KeyField = "Id";
private String OperateField = DicKeys[DicKeys.length-1];//操作字段
private String[] AllFields = {"Id", "Code", "Name", "IdP", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[] ListFields = {"Code", "Name", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[] PrintFields = {"Code", "Name", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[] FormFields = {"Code", "Name", "RfidId", "RfidCode", "Type", "Orderno", "Remark"};
private String[] QueryFields = {"Name", "RfidCode", "Type"};
private Address getByParameterDb(javax.servlet.http.HttpServletRequest request)
{
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Address pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
...
private void setListData(javax.servlet.http.HttpServletRequest request, Address pv, List cdt)
{
    List rows = new ArrayList();
...
private List getListCondition(javax.servlet.http.HttpServletRequest request, Address pv, boolean isAll)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    ...
    String qval = "";
    int qvali = -1;
    qvali = ParamUtils.getIntParameter(request,"pid",0);
    if(qvali>0)
    {
      cdt.add("(pid="+qvali+" )");
    }
...
private void setList(javax.servlet.http.HttpServletRequest request, boolean isAll)
{
    ...
    request.setAttribute("classname", "Address");
    request.setAttribute("describe", "存放地址");
    request.setAttribute("OperateField",OperateField);
}
private List getListJsonRows(javax.servlet.http.HttpServletRequest request, Address pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    Map RfidNamemap = CEditConst.getRfidNameMap(userInfo);
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        map.put("RfidId",(String)RfidNamemap.get("" + v.getRfidId()));
...
private void setListJsonData(javax.servlet.http.HttpServletRequest request, Address pv, List cdt)
{
...
private void setForm(javax.servlet.http.HttpServletRequest request, Address form)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
 ...
 */
private boolean isDuplicated(Address form, String cmd)
{
    List cdt = new ArrayList();
...
private List mkRtn(String cmd, String forward, Address form)
{
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    String cmd = ParamUtils.getParameter(request, "cmd", "list");
    log.debug("cmd=" + cmd);
    Address form = getByParameterDb(request);
    if (cmd.equals("list"))
    {
        setList(request);
...
forwardMap.put("list", "AddressAction.jsp");
forwardMap.put("failure", "AddressForm.jsp");
forwardMap.put("success", "AddressList.jsp");
forwardMap.put("listjquery", "AddressListJquery.jsp");
if(userInfo!=null)
{
...
forwardMap.put("input", "AddressForm.jsp");
forwardMap.put("jqueryInput", "AddressFormJquery.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script type=\"text/JavaScript\">window.location='AddressAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
