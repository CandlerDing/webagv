...
function save() {
            if (doValidate('postForm_TaskState')) postForm_TaskState.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_TaskState.cmd.value = 'list' ;document.queryForm_TaskState.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_TaskState.cmd.value = 'excel'; document.queryForm_TaskState.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[任务状态]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_TaskState" id="queryForm_TaskState">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_TaskState')" />
</td></tr></form></table>
</div>
