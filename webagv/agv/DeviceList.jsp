...
function save() {
            if (doValidate('postForm_Device')) postForm_Device.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Device.cmd.value = 'list' ;document.queryForm_Device.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Device.cmd.value = 'excel'; document.queryForm_Device.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[设备]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Device" id="queryForm_Device">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_Device')" />
</td></tr></form></table>
</div>
