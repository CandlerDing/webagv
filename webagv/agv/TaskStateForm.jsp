...
<%
Log log = LogFactory.getLog(TaskState.class);
...
TaskState v = (TaskState)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_TaskState.reset();" style="cursor:pointer;"></li>
        <li><a href="TaskStateAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
