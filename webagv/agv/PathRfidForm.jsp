...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_PathRfid.reset();" style="cursor:pointer;"></li>
        <li><a href="PathRfidAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<input type="hidden" name="NearId" value="<%=v.getNearId()%>">
<tr id="postForm_PathRfid_NearName"><td class="td_label">
<div align="right">靠近点名称:</div>
</td><td class="td_value">
<input name="NearName" id="_NearName_" size="50" maxlength="50" value="<%=v.getNearName()%>">
</td></tr>
