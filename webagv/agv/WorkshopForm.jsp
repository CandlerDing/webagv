...
<%
Log log = LogFactory.getLog(Workshop.class);
...
Workshop v = (Workshop)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_Workshop.reset();" style="cursor:pointer;"></li>
        <li><a href="WorkshopAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_Workshop" id="postForm_Workshop">
