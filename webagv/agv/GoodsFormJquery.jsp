...
function save() {
    	$("#postForm_Goods").attr("target","self");
    	$("#postForm_Goods").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	...
    	var isValid = $("#postForm_Goods").form("validate");
    	if (!isValid){
...
<input name="AddressId"  id="AddressId" class="easyui-numberbox" size="-1" value="<%=v.getAddressId()%>"">
</td></tr>
