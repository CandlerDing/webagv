...
function save() {
            if (doValidate('postForm_Controltype')) postForm_Controltype.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Controltype.cmd.value = 'list' ;document.queryForm_Controltype.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Controltype.cmd.value = 'excel'; document.queryForm_Controltype.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[控制方式]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Controltype" id="queryForm_Controltype">
...
<input name="_Priority_" id="_Priority_" value="<%=ParamUtils.getParameter(request, "_Priority_", "")%>">
</td>
<td colspan="4">&nbsp;</td>
</tr><tr><td colspan="8" align="center">
<input type="button" value="Reset" onClick="clearForm('queryForm_Controltype')" />
</td></tr></form></table>
</div>
