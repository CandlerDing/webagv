...
function save() {
    	$("#postForm_Device").attr("target","self");
    	$("#postForm_Device").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	});
    	$("#postForm_Device").form({
    	...
    	var isValid = $("#postForm_Device").form("validate");
    	if (!isValid){
...
<input type="hidden" name="AddressId" id="AddressId" value="<%=v.getAddressId()%>">
