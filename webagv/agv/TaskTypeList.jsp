...
function save() {
            if (doValidate('postForm_TaskType')) postForm_TaskType.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_TaskType.cmd.value = 'list' ;document.queryForm_TaskType.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_TaskType.cmd.value = 'excel'; document.queryForm_TaskType.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[任务类型]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_TaskType" id="queryForm_TaskType">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_TaskType')" />
</td></tr></form></table>
</div>
