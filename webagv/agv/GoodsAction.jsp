...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "Code", "Name", "IdP", "AddressId", "Type", "Orderno", "Remark"};
private String[] DicKeys = {"Id", "Code", "Name", "IdP", "AddressId", "Type", "Orderno", "Remark"};
private String[][] DicValues = {{"int", "id", "-1", "hidden", ""}, {"string", "编码", "50", "text", ""}, {"string", "名称", "50", "text", ""}, {"int", "父ID", "-1", "hidden", ""}, {"int", "存放地址ID", "-1", "text", ""}, {"string", "类型", "50", "text", ""}, {"int", "排序", "-1", "text", ""}, {"string", "备注", "50", "text", ""}};
private String KeyField = "Id";
private String OperateField = DicKeys[DicKeys.length-1];//操作字段
private String[] AllFields = {"Id", "Code", "Name", "IdP", "AddressId", "Type", "Orderno", "Remark"};
private String[] ListFields = {"Code", "Name", "AddressId", "Type", "Orderno", "Remark"};
private String[] PrintFields = {"Code", "Name", "AddressId", "Type", "Orderno", "Remark"};
private String[] FormFields = {"Code", "Name", "AddressId", "Type", "Orderno", "Remark"};
private String[] QueryFields = {"Name", "AddressId", "Type", "Orderno"};
private Goods getByParameterDb(javax.servlet.http.HttpServletRequest request)
{
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Goods pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    //查询符合条件的资料
...
private void setListData(javax.servlet.http.HttpServletRequest request, Goods pv, List cdt)
{
    List rows = new ArrayList();
...
private List getListCondition(javax.servlet.http.HttpServletRequest request, Goods pv, boolean isAll)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    ...
    qvali = ParamUtils.getIntParameter(request, "_Orderno_", -1);
    QueryValues.add(""+qvali);
    if (qvali >= 0) {
        cdt.add("orderno=" + qvali);
    }
    if (!isAll) {
...
private void setList(javax.servlet.http.HttpServletRequest request, boolean isAll)
{
    ...
    request.setAttribute("classname", "Goods");
    request.setAttribute("describe", "货品管理");
    request.setAttribute("OperateField",OperateField);
}
private List getListJsonRows(javax.servlet.http.HttpServletRequest request, Goods pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    //查询符合条件的资料
...
private void setListJsonData(javax.servlet.http.HttpServletRequest request, Goods pv, List cdt)
{
...
private void setForm(javax.servlet.http.HttpServletRequest request, Goods form)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    request.setAttribute("dickeys", DicKeys);
 ...
 */
private boolean isDuplicated(Goods form, String cmd)
{
    List cdt = new ArrayList();
...
private List mkRtn(String cmd, String forward, Goods form)
{
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    String cmd = ParamUtils.getParameter(request, "cmd", "list");
    log.debug("cmd=" + cmd);
    Goods form = getByParameterDb(request);
    if (cmd.equals("list"))
    {
        setList(request);
...
forwardMap.put("list", "GoodsAction.jsp");
forwardMap.put("failure", "GoodsForm.jsp");
forwardMap.put("success", "GoodsList.jsp");
forwardMap.put("listjquery", "GoodsListJquery.jsp");
if(userInfo!=null)
{
...
forwardMap.put("input", "GoodsForm.jsp");
forwardMap.put("jqueryInput", "GoodsFormJquery.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script type=\"text/JavaScript\">window.location='GoodsAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
