...
function save() {
            if (doValidate('postForm_Goods')) postForm_Goods.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Goods.cmd.value = 'list' ;document.queryForm_Goods.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Goods.cmd.value = 'excel'; document.queryForm_Goods.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[货品管理]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Goods" id="queryForm_Goods">
...
<input name="_AddressId_" id="_AddressId_" value="<%=ParamUtils.getParameter(request, "_AddressId_", "")%>">
</td>
<td>
...
<input name="_Orderno_" id="_Orderno_" value="<%=ParamUtils.getParameter(request, "_Orderno_", "")%>">
</td>
<td colspan="4">&nbsp;</td>
</tr><tr><td colspan="8" align="center">
<input type="button" value="Reset" onClick="clearForm('queryForm_Goods')" />
</td></tr></form></table>
</div>
