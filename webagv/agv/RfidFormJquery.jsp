...
function save() {
    	$("#postForm_Rfid").attr("target","self");
    	$("#postForm_Rfid").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	...
    	var isValid = $("#postForm_Rfid").form("validate");
    	if (!isValid){
...
<input type="text" class="easyui-textbox" name="Wladdress"  id="Wladdress" size="50" maxlength="50" value="<%=v.getWladdress()%>">
</td></tr>
<tr id="postForm_Rfid_OnlyId"><td class="td_label">
