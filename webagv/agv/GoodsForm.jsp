...
<%
Log log = LogFactory.getLog(Goods.class);
...
Goods v = (Goods)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_Goods.reset();" style="cursor:pointer;"></li>
        <li><a href="GoodsAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_Goods" id="postForm_Goods">
...
<tr id="postForm_Goods_AddressId"><td class="td_label">
<div align="right">存放地址ID:</div>
</td><td class="td_value">
<input name="AddressId" id="_AddressId_" value="<%=v.getAddressId()%>">
</td></tr>
<tr id="postForm_Goods_Type"><td class="td_label">
<div align="right">类型:</div>
</td><td class="td_value">
<input name="Type" id="_Type_" size="50" maxlength="50" value="<%=v.getType()%>">
</td></tr>
<tr id="postForm_Goods_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno" id="_Orderno_" value="<%=v.getOrderno()%>">
</td></tr>
<tr id="postForm_Goods_Remark"><td class="td_label">
