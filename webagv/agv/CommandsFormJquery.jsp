...
function save() {
    	$("#postForm_Commands").attr("target","self");
    	$("#postForm_Commands").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	});
    	$("#postForm_Commands").form({
    	...
    	var isValid = $("#postForm_Commands").form("validate");
    	if (!isValid){
...
<input name="Speed"  id="Speed" class="easyui-numberbox" precision="2" size="0" value="<%=v.getSpeed()%>"">
</td></tr>
<tr id="postForm_Commands_Commandcode"><td class="td_label">
<div align="right">命令代码:</div>
</td><td class="td_value">
<input type="text" class="easyui-textbox" name="Commandcode"  id="Commandcode" size="50" maxlength="50" value="<%=v.getCommandcode()%>">
</td></tr>
