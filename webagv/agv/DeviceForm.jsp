...
Device v = (Device)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_Device.reset();" style="cursor:pointer;"></li>
        <li><a href="DeviceAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_Device" id="postForm_Device">
...
<input type="hidden" name="AddressId" value="<%=v.getAddressId()%>">
<tr id="postForm_Device_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno" id="_Orderno_" value="<%=v.getOrderno()%>">
</td></tr>
<tr id="postForm_Device_Remark"><td class="td_label">
