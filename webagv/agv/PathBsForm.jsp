...
<%
Log log = LogFactory.getLog(PathBs.class);
...
PathBs v = (PathBs)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_PathBs.reset();" style="cursor:pointer;"></li>
        <li><a href="PathBsAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_PathBs" id="postForm_PathBs">
...
<tr id="postForm_PathBs_OnlyId"><td class="td_label">
<div align="right">标识ID:</div>
</td><td class="td_value">
<input name="OnlyId" id="_OnlyId_" size="50" maxlength="50" value="<%=v.getOnlyId()%>">
</td></tr>
<tr id="postForm_PathBs_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno" id="_Orderno_" value="<%=v.getOrderno()%>">
</td></tr>
<tr id="postForm_PathBs_Remark"><td class="td_label">
