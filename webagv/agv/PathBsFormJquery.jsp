...
function save() {
    	$("#postForm_PathBs").attr("target","self");
    	$("#postForm_PathBs").on("submit", function(event) {
        	$.messager.progress({
            		title : "提示",
            		text : "请稍后...."
        	});
    	});
    	$("#postForm_PathBs").form({
    	...
    	var isValid = $("#postForm_PathBs").form("validate");
    	if (!isValid){
...
<input type="text" class="easyui-textbox" name="OnlyId"  id="OnlyId" size="50" maxlength="50" value="<%=v.getOnlyId()%>">
</td></tr>
