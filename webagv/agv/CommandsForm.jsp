...
<%
Log log = LogFactory.getLog(Commands.class);
...
Commands v = (Commands)request.getAttribute("fromBean");
if (v == null) {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><img src="<%=request.getContextPath()%>/images/default/s_sx.gif" border=0 onclick="document.postForm_Commands.reset();" style="cursor:pointer;"></li>
        <li><a href="CommandsAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>"><img src="<%=request.getContextPath()%>/images/default/s_back.gif"></a></li>
    </ul>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" method="post" name="postForm_Commands" id="postForm_Commands">
...
<tr id="postForm_Commands_Type"><td class="td_label">
<div align="right">类型:</div>
</td><td class="td_value">
<input name="Type" id="_Type_" size="50" maxlength="50" value="<%=v.getType()%>">
</td></tr>
<tr id="postForm_Commands_Speed"><td class="td_label">
<div align="right">小车速度:</div>
</td><td class="td_value">
<input name="Speed" id="_Speed_" value="<%=v.getSpeed()%>">
</td></tr>
<tr id="postForm_Commands_Commandcode"><td class="td_label">
<div align="right">命令代码:</div>
</td><td class="td_value">
<input name="Commandcode" id="_Commandcode_" size="50" maxlength="50" value="<%=v.getCommandcode()%>">
</td></tr>
<tr id="postForm_Commands_StartTime"><td class="td_label">
<div align="right">开始时间:</div>
</td><td class="td_value">
<input name="StartTime" id="_StartTime_" size="50" maxlength="50" value="<%=v.getStartTime()%>">
</td></tr>
<tr id="postForm_Commands_Orderno"><td class="td_label">
<div align="right">排序:</div>
</td><td class="td_value">
<input name="Orderno" id="_Orderno_" value="<%=v.getOrderno()%>">
</td></tr>
<tr id="postForm_Commands_Remark"><td class="td_label">
