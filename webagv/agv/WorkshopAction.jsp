...
<%!
private static Log log = LogFactory.getLog(Workshop.class);
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "Code", "Name", "IdP", "Type", "Orderno", "Remark"};
private String[] DicKeys = {"Id", "Code", "Name", "IdP", "Type", "Orderno", "Remark"};
private String[][] DicValues = {{"int", "id", "-1", "hidden", ""}, {"string", "编码", "50", "text", ""}, {"string", "名称", "50", "text", ""}, {"int", "父ID", "-1", "hidden", ""}, {"string", "类型", "50", "text", ""}, {"int", "排序", "-1", "text", ""}, {"string", "备注", "50", "text", ""}};
private String KeyField = "Id";
private String OperateField = DicKeys[DicKeys.length-1];//操作字段
private String[] AllFields = {"Id", "Code", "Name", "IdP", "Type", "Orderno", "Remark"};
private String[] ListFields = {"Code", "Name", "Type", "Orderno", "Remark"};
private String[] PrintFields = {"Code", "Name", "Type", "Orderno", "Remark"};
private String[] FormFields = {"Code", "Name", "Type", "Orderno", "Remark"};
private String[] QueryFields = {"Name", "Type"};
private Workshop getByParameterDb(javax.servlet.http.HttpServletRequest request)
{
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Workshop pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    //查询符合条件的资料
...
private void setListData(javax.servlet.http.HttpServletRequest request, Workshop pv, List cdt)
{
    List rows = new ArrayList();
...
private List getListCondition(javax.servlet.http.HttpServletRequest request, Workshop pv, boolean isAll)
{
    UserInfo userInfo = Tool.getUserInfo(request);
...
private void setList(javax.servlet.http.HttpServletRequest request, boolean isAll)
{
    ...
    request.setAttribute("classname", "Workshop");
    request.setAttribute("describe", "车间管理");
    request.setAttribute("OperateField",OperateField);
}
private List getListJsonRows(javax.servlet.http.HttpServletRequest request, Workshop pv, List cdt)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    //查询符合条件的资料
...
private void setListJsonData(javax.servlet.http.HttpServletRequest request, Workshop pv, List cdt)
{
...
private void setForm(javax.servlet.http.HttpServletRequest request, Workshop form)
{
    UserInfo userInfo = Tool.getUserInfo(request);
    //默认值定义
    request.setAttribute("dickeys", DicKeys);
 ...
 */
private boolean isDuplicated(Workshop form, String cmd)
{
    List cdt = new ArrayList();
...
private List mkRtn(String cmd, String forward, Workshop form)
{
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    String cmd = ParamUtils.getParameter(request, "cmd", "list");
    log.debug("cmd=" + cmd);
    Workshop form = getByParameterDb(request);
    if (cmd.equals("list"))
    {
        setList(request);
...
forwardMap.put("list", "WorkshopAction.jsp");
forwardMap.put("failure", "WorkshopForm.jsp");
forwardMap.put("success", "WorkshopList.jsp");
forwardMap.put("listjquery", "WorkshopListJquery.jsp");
if(userInfo!=null)
{
...
forwardMap.put("input", "WorkshopForm.jsp");
forwardMap.put("jqueryInput", "WorkshopFormJquery.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script type=\"text/JavaScript\">window.location='WorkshopAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
