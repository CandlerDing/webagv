...
.left_t{ background:url(../images/yi.jpg) repeat-x; height:38px; line-height:38px; font-family:"Œ¢»Ì—≈∫⁄"; font-size:18px; color:#FFF; padding-left:15px; font-weight:bold; width:220px; float:left;}
...
.content table td{ font-family:"Œ¢»Ì—≈∫⁄"; font-size:16px; color:#2c4156; line-height:70px;}
.content table td input{ height:25px; line-height:25px;}
#confirm{ background:url(../images/dengl.jpg) repeat-x; height:30px; line-height:30px; width:210px; text-align:center; color:#FFF; border:0px; font-family:"Œ¢»Ì—≈∫⁄"; font-size:14px;}
.content table td table td{ font-family:"ÀŒÃÂ"; font-size:13px;}
.biaozhi{left:-25px; top:-37px; position:absolute;}
.tool_x table td{ font-family:"Œ¢»Ì—≈∫⁄"; font-size:17px; line-height:35px; color:#3f70ae;}
.cont{ padding:20px 15px; position:relative;}
.survey_t{ background:url(../images/tio_t.png) no-repeat; height:34px; line-height:34px;}
.survey_t span{ font-family:"Œ¢»Ì—≈∫⁄"; font-size:14px; color:#e1f9ff; padding-left:10px;}
...
.virtue_t span{font-family:"Œ¢»Ì—≈∫⁄"; font-size:14px; color:#fff; padding-left:10px;}
.virtue_z{}
.virtue_x{ background:url(../images/tio_x.png) no-repeat; height:4px;}
.virtue_z ul li a{ background:url(../images/xing.png) no-repeat; height:33px; line-height:33px; padding-left:27px; font-family:"Œ¢»Ì—≈∫⁄"; color:#afd7ea; width:175px; float:left;}
.effect{ border:1px solid #cdd9e6; background:#FFF; margin-bottom:10px; margin-top:2px;}
.effect_l{ float:left;}
.effect_r{padding:10px;}
.effect table td p a{ line-height:40px; font-size:13px; color:#244d7f; font-family:"Œ¢»Ì—≈∫⁄";}
...
<span>µ±«∞”√ªß: <%=officecode!=null?officecode.getName():"" %>&nbsp;&nbsp;<%=userName.length()>0?userName:"" %></span> 
<span>»’∆⁄£∫<%=riqi %>&nbsp;&nbsp;<%=String.format("%ta", new Date()) %></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
</BODY>
</HTML>
