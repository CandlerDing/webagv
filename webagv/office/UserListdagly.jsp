...
<td>
<div align="right">工作年月</div>
</td><td>
<input name="_WorkStart_" value="<%=ParamUtils.getParameter(request, "_WorkStart_", "")%>">
</td>
<td>
<div align="right">编制</div>
</td><td>
<input name="_UserBz_" value="<%=ParamUtils.getParameter(request, "_UserBz_", "")%>">
</td>
</tr><tr>
<td>
<div align="right">行政职级</div>
</td><td>
<input name="_Xzzj_" value="<%=ParamUtils.getParameter(request, "_Xzzj_", "")%>">
</td>
<td>
<div align="right">职务</div>
</td><td>
<%=HtmlTool.renderSelect(ZhiWeioptions, ParamUtils.getParameter(request,"_ZhiWu_",""), "_ZhiWu_", "")%>
<%//radio形式%>
<%//ZhiWeioptions.remove(0);%>
<%//=HtmlTool.renderRadio(ZhiWeioptions, ParamUtils.getParameter(request,"_ZhiWu_",""), "_ZhiWu_", "")%>
<%//checkbox形式%>
<%//=HtmlTool.renderCheckBox(ZhiWeioptions, ParamUtils.getParameter(request,"_ZhiWu_",""), "_ZhiWu_", "")%>
</td>
<td>
<div align="right">检察官等级大类</div>
</td><td>
<input name="_Jcgdjd_" value="<%=ParamUtils.getParameter(request, "_Jcgdjd_", "")%>">
</td>
</tr><tr>
<td>
<div align="right">检察官等级小类</div>
</td><td>
<input name="_Jcgdjx_" value="<%=ParamUtils.getParameter(request, "_Jcgdjx_", "")%>">
</td>
<td>
<div align="right">新检察人员分类</div>
</td><td>
<input name="_Jcfl_" value="<%=ParamUtils.getParameter(request, "_Jcfl_", "")%>">
</td>
<td>
<div align="right">法警等级</div>
</td><td>
<input name="_Fjdj_" value="<%=ParamUtils.getParameter(request, "_Fjdj_", "")%>">
</td>
</tr><tr>
<td>
<div align="right">档案专兼职</div>
</td><td>
<input name="_Dagly_" value="<%=ParamUtils.getParameter(request, "_Dagly_", "")%>">
</td>
<td>
