...
function save() {
            if (doValidate('postForm_Office')) postForm_Office.submit();
}
function initP() {
...
<div id="nav1" style="display:">
    <ul>
        ...
        <li><a href="javascript:document.queryForm_Office.cmd.value = 'list' ;document.queryForm_Office.submit();"><img src="<%=request.getContextPath()%>/images/default/button_cx.gif" alt="查询"></a></li>
        <li><a href="javascript:document.queryForm_Office.cmd.value = 'excel'; document.queryForm_Office.submit();"><img src="<%=request.getContextPath()%>/images/default/button_dc.gif" alt="导出Excel文件"></a></li>
        <li><b>[部门管理]</b></li>
...
<form action="<%=request.getAttribute("classname")%>Action.jsp" name="queryForm_Office" id="queryForm_Office">
...
<input type="button" value="Reset" onClick="clearForm('queryForm_Office')" />
</td></tr></form></table>
</div>
